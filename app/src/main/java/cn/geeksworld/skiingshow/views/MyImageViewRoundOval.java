...
public class MyImageViewRoundOval extends ImageView {
    ...
    public MyImageViewRoundOval(Context context) {
        this(context, null);
        // TODOAuto-generated constructor stub
    }

    public MyImageViewRoundOval(Context context, AttributeSet attrs) {
        this(context,attrs, 0);
        // TODOAuto-generated constructor stub
    }

    public MyImageViewRoundOval(Context context, AttributeSet attrs,int defStyle){
