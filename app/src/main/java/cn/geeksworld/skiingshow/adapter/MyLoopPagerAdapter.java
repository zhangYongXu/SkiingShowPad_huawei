 ...
 */
public abstract class MyLoopPagerAdapter extends PagerAdapter {
    private MyRollPagerView mViewPager;

    private ArrayList<View> mViewList = new ArrayList<>();

    private class LoopHintViewDelegate implements MyRollPagerView.HintViewDelegate{
        @Override
    ...
    public MyLoopPagerAdapter(MyRollPagerView viewPager){
